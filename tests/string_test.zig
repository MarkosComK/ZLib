...
test "String Function Tests" {
    ...
    // strLen tests
    {
        const len_t1 = zib.str.strLen("Hello");
        const len_t2 = zib.str.strLen("");
        const len_t3 = zib.str.strLen("H");
        const len_t4 = zib.str.strLen("Hello\n\t");
    ...
    // strCmp tests
    {
        const cmp_t1 = zib.str.strCmp("Hello", "Hello");
        const cmp_t2 = zib.str.strCmp("Hello", "hello");
        const cmp_t3 = zib.str.strCmp("", "");
        const cmp_t4 = zib.str.strCmp("A", "A");
    ...
    // strCpy tests
    {
        ...
        _ = try zib.str.strCpy(&buffer1, "Hello");
        _ = try zib.str.strCpy(&buffer2, "A");
    ...
    // strCat tests
    {
        ...
        const hello = "Hello";
        _ = try zib.str.strCpy(buffer[0..5], hello);

        // Test normal concatenation
        _ = try zib.str.strCat(buffer[0..20], " World");
        try std.testing.expectEqualSlices(u8, "Hello World", buffer[0..11]);

        // Test error case with small buffer
        const result_error = zib.str.strCat(short_buf[0..], " World");
