...
test "String Function Tests" {
    ...
    // Length Operations
    {
        ...
        printTestResult("{any:^14}", "length_basic_string      ", 5, len_normal, len_normal == 5);
        printTestResult("{any:^14}", "length_empty_string      ", 0, len_empty, len_empty == 0);
        printTestResult("{any:^14}", "length_single_char       ", 1, len_single, len_single == 1);
        printTestResult("{any:^14}", "length_with_escapes      ", 7, len_special, len_special == 7);
